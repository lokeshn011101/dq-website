...
const HomeFooterItem = ({ comment, by, place }) => {
  return (
    <div className="comment flex flex-col justify-center items-center md:w-9/12 sm:w-10/12 w-11/12">
      <div className="cmt font-light italic text-center md:pt-10 mdd:pt-8 smm:pt-6 md:pb-5 mdd:pb-4 smm:pb-3 md:leading-10 leading-6 md:text-lg text-base">
        {comment}
      </div>
      <div className="name-place flex flex-row md:pb-10 mdd:pb-8 smm:pb-6">
        <span className="cmt-by uppercase tracking-widest smm:text-sm">
          {by}
        </span>
        <span className="ml-2 place italic font-light tracking-widest smm:text-sm">
          {place}
        </span>
      </div>
    </div>
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="section md:px-24 sm:px-10 smm:px-8 flex flex-col justify-center items-center">
        <div className="text-3xl mb-10 mt-24 flex flex-row smm:flex-col justify-center items-center">
          <div>~</div>
          <div className="text-center mx-2"> Where Dreams, Come Alive! </div>
          <div>~</div>
        </div>
        <div className="text-center w-8/12 mdd:w-full md:leading-10 leading-6 md:text-lg text-base font-light">
      ...
      <div className="homeflow flex justify-center items-center md:my-32 mdd:my-20 smm:my-14">
...
services we offer and get in touch so we can discuss how to accommodate your requirements!"
      ...
      <div className="home-footer">
        <div className="home-footer-title text-3xl mb-10 mt-16 flex flex-row smm:flex-col justify-center items-center">
          <div>~</div>
        ...
        <div className="flex justify-center items-center">
          <div className="nav-logo w-8/12 smm:w-10/12 flex justify-center items-center sm:-mb-20 -mb-16">
            <Image src="/home-footer.png" width={1198} height={801} />
          </div>
        </div>
        <div className="pb-10 md:pt-28 pt-16 bg-gray-200 flex flex-col justify-center items-center">
          <HomeFooterItem
